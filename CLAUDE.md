...
Vigilo is a Flutter application generated by OneWeekApp AI Software Factory. It uses Supabase as the backend, Riverpod for state management, Go Router for navigation, and SharedPreferences for local settings.
