...
Vigilo is a Flutter app for workplace safety in construction sites. It uses Supabase as backend, Riverpod 3.0+ for state management, Go Router for navigation, and SharedPreferences for local settings persistence. Generated by the OneWeekApp AI Software Factory.
...
- `docs/PROGETTO.md` — Full functional specification
- `docs/WIREFRAMES.md` — ASCII wireframes for all screens
- `docs/VIGILO_MGMT_SPEC.md` — Management dashboard spec
- `docs/ROADMAP.md` — Roadmap and gap analysis
- `docs/SSCC_TECHNICAL_SPEC.md` — Helmet-centric system technical spec
- `docs/PIATTAFORMA_FORMAZIONE.md` — LMS platform spec
- `docs/BUSINESS_PROPOSAL.md` — Business model and go-to-market
